...
public class userid implements Serializable{
	...
	public userid(String rpi_id, int weather_code, int horo_code, int stock_num1, int stock_num2,
			int stock_num3) {
		super();
		Rpi_id = rpi_id;
		Weather_code = weather_code;
	...
	public userid(int id, String rpi_id, int weather_code, int horo_code, int stock_num1, int stock_num2,
			int stock_num3) {
		super();
		this.id = id;
		Rpi_id = rpi_id;
